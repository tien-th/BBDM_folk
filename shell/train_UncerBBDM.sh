...
# python3 main.py --config configs/UncerBBDM3c.yaml --sample_to_eval --gpu_ids 3 --resume_model results/108_CT2PET_UncerBBDM3c/LBBDM-f4/checkpoint/top_model_epoch_198.pth  --resume_optim results/108_CT2PET_UncerBBDM3c/LBBDM-f4/checkpoint/top_optim_sche_epoch_198.pth
