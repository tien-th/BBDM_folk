...
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 3 --resume_model results/123_UncerBBDM_1Unet_confloss_15k_alpha_1/LBBDM-f4/checkpoint/top_model_epoch_136.pth  --resume_optim results/123_UncerBBDM_1Unet_confloss_15k_alpha_1/LBBDM-f4/checkpoint/top_optim_sche_epoch_136.pth
