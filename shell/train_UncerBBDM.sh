# train
# python3 main.py --config configs/UncerBBDM.yaml --train --sample_at_start --save_top --gpu_ids 1
# python3 main.py --config configs/UncerBBDM3c.yaml --train --sample_at_start --save_top --gpu_ids 3
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 1 --resume_model results/UncerBBDM_2Unet_confloss_15k_v1/LBBDM-f4/checkpoint/last_model.pth  --resume_optim results/UncerBBDM_2Unet_confloss_15k_v1/LBBDM-f4/checkpoint/last_optim_sche.pth
