...
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 3 --resume_model results/UncerBBDM_4Unet_confloss_15k_v1/LBBDM-f4/checkpoint/last_model.pth  --resume_optim results/UncerBBDM_4Unet_15k_v1/LBBDM-f4/checkpoint/last_optim_sche.pth
