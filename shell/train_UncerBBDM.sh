...
# python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 3 --resume_model results/UncerBBDM_1Unet_10k_v2/LBBDM-f4/checkpoint/top_model_epoch_146.pth  --resume_optim results/UncerBBDM_1Unet_10k_v2/LBBDM-f4/checkpoint/top_optim_sche_epoch_146.pth
