...
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 0 --resume_model results/UncerBBDM_3Unet_confloss_15k_v1/LBBDM-f4/checkpoint/top_model_epoch_90.pth  --resume_optim results/UncerBBDM_3Unet_15k_v1/LBBDM-f4/checkpoint/top_optim_sche_epoch_90.pth
