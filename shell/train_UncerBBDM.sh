...
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 0 --resume_model /home/PET-CT/unet_ckpts/top_model_epoch_260.pth  --resume_optim /home/PET-CT/unet_ckpts/top_model_epoch_260.pth
