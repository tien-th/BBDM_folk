...
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 0 --resume_model results/UncerBBDM_1Unet_confloss_15k_v1/LBBDM-f4/checkpoint/last_model.pth  --resume_optim results/UncerBBDM_1Unet_confloss_15k_v1/LBBDM-f4/checkpoint/last_optim_sche.pth
