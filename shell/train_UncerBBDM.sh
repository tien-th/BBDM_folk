...
python3 main.py --config configs/UncerBBDM.yaml --sample_to_eval --gpu_ids 2 --resume_model results/UncerBBDM_2Unet/LBBDM-f4/checkpoint/top_model_epoch_182.pth  --resume_optim results/UncerBBDM_2Unet/LBBDM-f4/checkpoint/top_optim_sche_epoch_182.pth
