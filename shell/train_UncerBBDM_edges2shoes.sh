# train
# python3 main.py --config configs/edges2shoes.yaml --train --sample_at_start --save_top --gpu_ids 0
python3 main.py --config configs/edges2shoes.yaml --sample_to_eval --gpu_ids 0 --resume_model results/UncerBBDM_2Unet_confloss_edges2shoes_v1/LBBDM-f4/checkpoint/top_model_epoch_40.pth  --resume_optim results/UncerBBDM_2Unet_confloss_edges2shoes_v1/LBBDM-f4/checkpoint/top_optim_sche_epoch_40.pth
