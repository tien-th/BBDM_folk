...
#test
#python3 main.py --config configs/conditional_LBBDM.yaml --train --sample_at_start --save_top --gpu_ids 2
python3 main.py --config configs/conditional_LBBDM.yaml --sample_to_eval --gpu_ids 0 --resume_model results/1212_conditional_LBBDM/LBBDM-f4/checkpoint/top_model_epoch_66.pth 
