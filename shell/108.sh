...
# python3 main.py --seed 1234 --config configs/Template_CPDM.yaml --train --sample_at_start --save_top --gpu_ids 2
python3 main.py --seed 1234 --config configs/Template_CPDM.yaml --sample_to_eval --gpu_ids 0 --resume_model /home/PET-CT/thaind/BBDM_folk/results/317_class_conditional_BBDM_kmeans_segment_seed1234/LBBDM-f4/checkpoint/top_model_epoch_66.pth
