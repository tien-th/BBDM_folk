...
python3 main.py --config configs/conditional_LBBDM.yaml --sample_to_eval --gpu_ids 1 --resume_model /home/PET-CT/thaind/BBDM_folk/results/227_conditional_LBBDM_CT/LBBDM-f4/checkpoint/top_model_epoch_30.pth
