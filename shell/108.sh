...
python3 main.py --config configs/conditional_LBBDM.yaml --sample_to_eval --gpu_ids 0 --resume_model results/1219_detected_conditional_LBBDM_alpha_2/LBBDM-f4/checkpoint/top_model_epoch_56.pth 
