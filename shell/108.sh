...
python3 main.py --config configs/conditional_LBBDM.yaml --sample_to_eval --gpu_ids 0 --resume_model results/1226_segmented_conditional_LBBDM_focal_loss_0.5/LBBDM-f4/checkpoint/top_model_epoch_52.pth 
