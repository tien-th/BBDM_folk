...
def calc_FID(input_path1, input_path2):
    fid_value = fid_score.calculate_fid_given_paths([input_path1, input_path2], batch_size=1, device=torch.device('cuda:0'), dims=2048)  # 2048,768,192,64
...
if __name__ == "__main__": 
    calc_FID('/home/PET-CT/thaind/BBDM_folk/results/UncerBBDM_1Unet_confloss_edges2shoes_v1/LBBDM-f4/sample_to_eval/200', '/home/PET-CT/edges2shoes/test/B')
